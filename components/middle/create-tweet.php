<div id="home-menu">
  ...
  <svg viewBox="0 0 24 24" id="home-start-icon">
    <path
...
<form id="create-tweet" onsubmit="createTweet(); return false">
  <div id="tweet-message-style">
    <input id="tweet_message" name="tweet_message" type="text" placeholder="What's happeneing">
