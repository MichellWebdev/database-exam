<div id="trends">
    ...
    <div class="trending">
      <p class="trending__text">Trending entertainment</p>
      <p class="trending__hashtag">#Disney</p>
    </div>
    <div class="trending">
      <p class="trending__text">Trending in USA</p>
      <p class="trending__hashtag">#Supernatural</p>
    </div>
    <div class="trending">
      <p class="trending__text">Trending in Denmark</p>
      <p class="trending__hashtag">#Clippers</p>
    </div>
    <div class="trending">
      <p class="trending__text">Trending in USA</p>
      <p class="trending__hashtag">#Bones</p>
    </div>
    <div class="trending">
      <p class="trending__text">Trending in Denmark</p>
      <p class="trending__hashtag">#Politics</p>
    </div>
    <div class="trending">
      <p class="trending__text--show-more">Show more</p>
    </div>
  </div>